...
- Name: ui.spec.js >> UI Regression Tests >> inactive vendors should not show up in the assignment dropdown
- Location: ui.spec.js:26:7
...
Expected substring: not "Old Ledger Associates"
Received string:        "Unassigned
Swift Verify Co
ClearCheck Partners
Old Ledger Associates"
```
